...
Welcome to the YourFinanceWORKS documentation hub. This page links all available guides and technical resources for users, administrators, and developers.
...
- **[Cloud Storage & Attachments](features/CLOUD_STORAGE.md)**: Managing receipts, statements, and secure file storage.
- **[Slack Integration](features/SLACK_INTEGRATION.md)**: Managing invoices and clients from your Slack workspace.
- **[External Transactions & API](features/EXTERNAL_TRANSACTIONS.md)**: AI statement processing and 3rd-party integrations.
- **[SSO Authentication](features/SSO_AUTHENTICATION.md)**: Enterprise identity with Google and Azure AD.
- **[AI Chat Bot (MCP Assistant)](features/AI_SERVICES.md)**: Natural language queries and automated insights.
...
See our **[Support Guide](../SUPPORT.md)** or open an issue in the repository.
