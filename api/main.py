...
from core.routers import (
    ...
    workflows,
    scheduled_job_alerts,  # Add the scheduled job alerts router
)
...
app.include_router(scheduled_job_alerts.router, prefix="/api/v1")  # Add the scheduled job alerts router
