...
from core.interfaces.storage_provider import CloudStorageProvider, StorageProvider, StorageConfig, HealthCheckResult
...
class StorageProviderFactory:
    ...
    def _get_provider_config(self, provider_type: StorageProvider) -> Optional[StorageConfig]:
        ...
        from commercial.cloud_storage.config import StorageProvider as ConfigStorageProvider
