...
from models.models_per_tenant import ScheduledReport, ReportTemplate, ReportHistory, User
from schemas.report import (
    ScheduledReportCreate, ScheduledReportUpdate, ScheduleConfig, 
    ReportResult, ReportStatus, ExportFormat
)
from services.report_service import ReportService
from services.email_service import EmailService, EmailMessage, EmailAttachment
...
class ReportScheduler:
    ...
    def execute_scheduled_report(self, schedule_id: int) -> ReportResult:
        ...
        try:
            ...
            from schemas.report import ReportTemplate as ReportTemplateSchema
