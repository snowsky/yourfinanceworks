...
from schemas.inventory import InventoryErrorResponse, InventoryValidationErrorResponse, ValidationErrorDetail
...
def validate_inventory_operation(operation: str, **kwargs) -> None:
    ...
    """
    from exceptions.inventory_exceptions import InventoryValidationException
