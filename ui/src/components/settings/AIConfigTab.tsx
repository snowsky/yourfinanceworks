                    ...
                    <div className="space-y-6 pt-8 border-t">
                        ...
                        <div className="p-6 bg-warning/10 border border-warning/30 rounded-xl">
                            <div className="flex items-start gap-3">
                                ...
                                <div className="space-y-1">
                                    <h4 className="font-semibold text-warning">{t('settings.ai_config.ai_usage_notice')}</h4>
                        ...
                        {testResult && (
                            <div className={`p-3 rounded-lg border ${testResult.success
                                ...
                                <div className="flex items-center gap-2">
                                    <div className={`w-2 h-2 rounded-full ${testResult.success ? 'bg-success' : 'bg-destructive'}`}></div>
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        <div className="grid grid-cols-2 gap-2 pt-2">
                                            ...
                                            {(reviewProgress.invoices.stats.failed > 0) && (
                                                 <div className="col-span-2 flex items-center gap-2 text-xs text-destructive bg-destructive/10 p-2 rounded border border-destructive/30">
                    ...
                    <AlertDialogHeader>
                        ...
                        <AlertDialogDescription>
                            ...
                            <div className="mt-4 p-3 bg-warning/10 rounded-lg border border-warning/30">
                                <p className="text-sm font-medium text-warning">⚠️ This action cannot be undone and may take a long time depending on your data volume.</p>
                            </div>
                        </AlertDialogDescription>
                    </AlertDialogHeader>
                    <AlertDialogFooter>
