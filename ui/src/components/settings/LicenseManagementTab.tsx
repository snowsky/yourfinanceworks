    ...
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div className="bg-gradient-to-r from-primary/10 via-primary/5 to-transparent rounded-2xl border border-primary/20 p-6 backdrop-blur-sm">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h2 className="text-2xl font-bold tracking-tight">{t('settings.license.tabTitle', 'License')}</h2>
            <p className="text-muted-foreground mt-0.5">{t('settings.license.description', 'View your license status and manage activation')}</p>
          </div>
        </div>
      </div>
